/* =========================================================================
   COMPONENTE ISOLADO: MODAL PIX VIP (HTML + CSS + JS UNIFICADOS)
   ========================================================================= */

(function initPixModalComponent() {
...
.pix-copy-area {
  ...
  // Fechar
  const fecharModal = () => overlay.classList.remove("open");
...
copyBtn.addEventListener("click", async () => {
    ...
    const originalText = `<i class="bi bi-clipboard"></i> Copiar código Pix`;
  ...
  window.fecharModalPix = fecharModal;
})();